...
const [user, setUser] = useState([]);
  ...
  return (
    <div className="container mx-auto mt-8 px-6 py-8 bg-white rounded-lg shadow-md">
...
<div className="w-2/3 font-normal">{order.address.zipcode}</div>
      ...
      <div>
        <div  style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset"}} className="bg-gray-100 p-6 rounded-lg shadow-md">
        ...
        <div  style={{boxShadow: "rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset"}} className="bg-gray-100 p-6 mt-4 rounded-lg shadow-md">
